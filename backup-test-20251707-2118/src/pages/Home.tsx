...
const Home: React.FC<HomeProps> = ({ navigate }) => {
  ...
  const handleEventEdit = useCallback((updatedEvent: Event) => {
    ...
    if (isCreating) {
      ...
      console.log('✅ HOME - Nouvel événement créé')
      ...
      console.log('✅ HOME - Événement modifié')
    } else {
  ...
  const handleEventCreated = useCallback((event: Event) => {
    console.log('✅ Événement créé, redirection vers calendrier:', event.title)
